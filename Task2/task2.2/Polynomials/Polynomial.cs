    ...
    public class Polynomial
    {
        ...
        public static Polynomial operator -(Polynomial p1, Polynomial p2)
        {
            ...
            else
            {
                ...
                for (int i = p2.Degree; i < 0; i--)
                {
                    coeff[i] = p2.Coefficients[i] - p1.Coefficients[i];
                }
                return new Polynomial(coeff, p2.Degree);
            }
        }
        ...
        {
            double[] coeff = new double[p1.Degree];
            if (number == 0)
            {
                return null;
            }
        ...
        public override bool Equals(object obj)
        {
            return obj is Polynomial polynomial &&
                   EqualityComparer<double[]>.Default.Equals(Coefficients, polynomial.Coefficients) &&
